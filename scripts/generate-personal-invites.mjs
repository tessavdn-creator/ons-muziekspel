...
await writeFile(join(outputRoot, 'LEES-MIJ.txt'), 'TRACKBACK PERSOONLIJKE UITNODIGINGEN\n\nIedere map bevat een privé-QR, een printbare uitnodiging en een klikbare link. Deel alleen de map van de juiste ontvanger: de QR is de toegangssleutel tot de persoonlijke bibliotheek van die ene persoon.\n')
