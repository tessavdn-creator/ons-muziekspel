...
if (!input || !output) throw new Error('Gebruik: node scripts/build-three-hard-editions.mjs KANDIDATEN.json UITVOER.json')
...
const editions = [
  edition('hidden-corners-01', 'Hidden Corners', 'De diepe platenkast', 'Zestig eigenzinnige keuzes en deep cuts. Weinig inkoppers, veel momenten waarop je het bijna weet.', hidden),
  edition('time-warp-01', 'The Crooked Timeline', 'Van 1941 tot nu', 'Zestig nummers, bewust verspreid over acht decennia. Remasters verraden het antwoord niet: het oorspronkelijke opnamejaar telt.', timeline),
  edition('after-dark-01', 'After Dark', 'Nachtelijke rituelen', 'Zestig stukken vol dreampop, vintage jazz, wereldmuziek, blues en psychedelische rafelranden.', afterDark),
]
